...
using System;
#if (PLATFORM_STANDALONE_OSX || UNITY_EDITOR_OSX || PLATFORM_STANDALONE_OSX)
using System.IO.Pipes; // Default pipes seems to work on OSX
#else
using ShadowGroveGames.GameRichPresenceIntegration.Scripts.Control.IO;
#endif
using System.IO;
