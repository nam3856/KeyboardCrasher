...
namespace ShadowGroveGames.GameRichPresenceIntegration.Scripts.Presence
{
    ...
    /// </summary>
    [System.Serializable]
    public class GameRichPresenceTimestamp
    {
        /// <summary>
        /// Representation of a invalid timestamp (unix epoch of 0 seconds).
        /// </summary>
        public static readonly GameRichPresenceTimestamp Invalid = new GameRichPresenceTimestamp(0L);
        ...
        /// </summary>
        public GameRichPresenceTimestamp()
        ...
        public GameRichPresenceTimestamp(DateTime time)
        ...
        public GameRichPresenceTimestamp(long timestamp)
        {
        ...
        public GameRichPresenceTimestamp(float time)
        {
        ...
        public GameRichPresenceTimestamp AddSeconds(int seconds)
        {
            timestamp += seconds;
            return this;
        }
        ...
        /// <returns>Returns the same timestamp object.</returns>
        public GameRichPresenceTimestamp AddMinutes(int minutes)
        {
        ...
        /// <returns>Returns the same timestamp object.</returns>
        public GameRichPresenceTimestamp AddMinutes(float minutes)
        {
        ...
        /// <returns>Returns the same timestamp object</returns>
        public GameRichPresenceTimestamp AddHours(int hours)
        {
        ...
        /// <returns>Returns the same timestamp object.</returns>
        public GameRichPresenceTimestamp AddHours(float hours)
        {
        ...
        public static implicit operator long(GameRichPresenceTimestamp stamp)
        {
        ...
        /// </summary>
        /// <param name="stamp">The timestamp</param>
        public static implicit operator float(GameRichPresenceTimestamp stamp)
        {
        ...
        /// </summary>
        /// <param name="stamp">The timestamp</param>
        public static implicit operator DateTime(GameRichPresenceTimestamp stamp)
        {
        ...
        public static implicit operator GameRichPresenceTimestamp(long time)
        {
            return new GameRichPresenceTimestamp(time);
        }
        ...
        public static implicit operator GameRichPresenceTimestamp(DateTime time)
        {
            return new GameRichPresenceTimestamp(time);
        }
        /// <summary>
        ...
        /// </summary>
        /// <param name="time">The time</param>
        public static implicit operator GameRichPresenceTimestamp(float time)
        {
            return new GameRichPresenceTimestamp(time);
        }
        #endregion
